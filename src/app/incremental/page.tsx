...
export const metadata = {
  title: "Incremental Fetching and Caching - Next JS 14",
};
  ...
  return (
    <div className="flex flex-col justify-center items-center mt-4">
      <h1 className="text-black border-red-400 bg-blue-200 border-2 rounded-lg px-10 py-4 my-4 w-3/4 text-sm sm:text-base">
        This Image Rendered Using Incremental Static Caching. The page will
        fetch and cache at build time, and the image will remain in the cache
        until the revalidation time period has passed. Then a refresh will
